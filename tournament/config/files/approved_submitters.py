...
class ApprovedSubmitters:
    ...
    def write_default(self):
        ...
        json.dump(self.default_submitters_details, open(paths.APPROVED_SUBMITTERS_LIST, 'w'), indent=4, sort_keys=True)
    ...
    def check_num_submitters(self) -> Result:
    ...
    def check_valid(self) -> Result:
        ...
        if result:
            result += self.check_num_submitters() + ""
        return result
