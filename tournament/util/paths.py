...
# Folder to store all traces generated by the tournament
TRACES_DIR = ROOT_DIR + "/traces"

# Trace file for tournament logs
TRACE_FILE = TRACES_DIR + "/tournament_traces.log"

# Trace file for results server
RESULTS_SERVER_TRACE_FILE = TRACES_DIR + "/results_server_traces.log"
